...
<head>
    ...
    @section('content')
        <div class="flex justify-center bg-dark">
            <form action="authorpostsEdit" method="post">
                @csrf
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                      <div class="form-control  max-w-xs">
                        ...
                        <button onclick="window.location.href='{{route('authorposts')}}'" type="button" class='btn btn-error btn-outline btn-sm' >Back</button>
                        </div>
                    </div>
                </div>
