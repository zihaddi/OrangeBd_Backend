            ...
            <div class="mr-3">
                ...
                <div class="mt-4 mb-3 form-control">
                    <label style="width: 300px;height:30px" class="input-group" for="inputGroupSelect01">
                        <span>Author</span>
                        <select style="width: 200px;height:30px" name='uid' class="input input-bordered"
                            id="inputGroupSelect01">
                            <option class="text-black" style="width: 300px;" selected disabled>--Author--</option>
                            @if ($author->count())
                                @foreach ($author as $country)
                ...
                <div class="flex justify-between">
                    ...
                    <button onclick="window.location.href='{{route('posts')}}'" type="button" class='btn btn-error btn-outline btn-sm mt-4' >Back</button>
                </div>
            </div>
        </form>
    </div>
